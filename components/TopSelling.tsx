...
const TopSelling = ({ products, loading }: TopSellingProps) => {
  return (
    <section className="w-full mt-12 lg:mt-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-[1240px] mx-auto py-10 lg:py-16">
        <div className="flex flex-col items-center">
          {/* Title */}
          <h2 className="font-integral text-[32px] leading-[36px] lg:text-[48px] lg:leading-[58px] font-bold text-center text-black uppercase">
            Top Selling
          </h2>
              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="flex flex-col gap-1">
                    {/* Name */}
                    <h3 className="text-[16px] lg:text-[20px] font-bold text-black leading-tight capitalize">
                      {product.name}
                    </h3>
