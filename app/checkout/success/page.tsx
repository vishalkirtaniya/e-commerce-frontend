...
export default function CheckoutSuccessPage() {
  ...
  const fetchOrder = async () => {
    ...
    try {
      ...
      // Still show success screen even if fetch fails — payment was confirmed
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <main className="min-h-screen bg-secondary-background flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-[600px] mx-auto">
            ...
            <>
              ...
              <div className="flex justify-between text-sm font-satoshi mb-1">
                ...
                <span className="font-bold text-base">
                  ₹{parseFloat(String(order.total)).toLocaleString("en-IN")}
                </span>
              </div>
        ...
        {/* Decorative star — matching your design system */}
